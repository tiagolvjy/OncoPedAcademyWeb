      ...
      <div className="flex flex-col flex-1 overflow-hidden">
        ...
        <header className="bg-(--background-primary) border-b border-[#e5e7eb] px-6 h-[56px] flex items-center justify-between flex-shrink-0">
          ...
          <div className="flex items-center gap-4 text-[#6b7280]">
            <i className="ion-ios-person text-[22px] cursor-pointer hover:text-[#374151]" />
            <i className="ion-ios-moon text-[20px] cursor-pointer hover:text-[#374151]" />
            <i className="ion-ios-bell text-[22px] cursor-pointer hover:text-[#374151]" />
          </div>
        </header>
